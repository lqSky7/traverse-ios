...
| :--- | :--- | :--- |
| `HomeScoreCards.swift` | Cards for current streak, revision score, and background lighting effects | `StreakCard`, `RevisionScoreCard`, `ThinkingOrbScoreView`, `LightingSunBackground` |
| `HomeStatsCards.swift` | Main solve statistics summary, performance metrics, and try distributions | `MainStatsCard`, `StatItem`, `PerformanceMetricsCard`, `TriesDistributionCard`, `ErrorView` |
